...
import { WaverThemes } from "./colors";
...
export default function getTheme(options: GetThemeOptions) {
  ...
  const theme = {
    ...
    colors: {
      ...
      "terminal.ansiBrightfuchsia": v("fuchsia"),
      ...
      "terminal.ansiBlack": pick({
        light: WaverThemes.background[0],
        dark: WaverThemes.foreground[1],
      }),
      "terminal.ansiBlue": v("blue"),
      "terminal.ansiCyan": v("cyan"),
      "terminal.ansiGreen": v("green"),
      "terminal.ansifuchsia": v("fuchsia"),
      ...
      "editorBracketHighlight.foreground1": v("gray"),
      "editorBracketHighlight.foreground2": v("gray"),
      "editorBracketHighlight.foreground3": v("gray"),
      "editorBracketHighlight.foreground4": v("gray"),
      "editorBracketHighlight.foreground5": v("gray"),
      "editorBracketHighlight.foreground6": v("gray"),

      "debugToolBar.background": background,
      "editor.stackFrameHighlightBackground": pick({
        light: colors.yellow[1],
        dark: "#a707",
      }),
